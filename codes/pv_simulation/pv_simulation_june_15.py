...
# select data for June 15th (row 3961 -> row 3985)
tmys_june_15 = []
for ind in range(len(tmys)):
    tmy_june_15 = tmys[ind].iloc[3961 : 3985]
    tmys_june_15.append(tmy_june_15)


for location, weather in zip(coordinates, tmys_june_15):
    latitude, longitude, name, altitude, timezone = location
